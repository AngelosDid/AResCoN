...
```
You should always use the latest version of AResCoN code (see https://github.com/AngelosDid/AResCoN/releases). I recommend not using the code from 1st release (which you can find on your right), since many updates have been made recently. If you are using Cellpose, ensure that you use the attached collab notebook which you can find at Arescon\Extra info you might need\Colab Notebook. After you install the environment, locate the main.py file and run the code. The GUI of AResCoN should open!
