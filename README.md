...
* If your PC needs much time to open Fiji, it is likely that you will encounter errors during the initiation steps of Fiji (read the disclaimer below). Time the seconds needed for your Fiji to open and ensure that your Fiji opens in less than 13 seconds. If the minimum value of 13 seconds is not sufficient, you can change yourself this limit in the Measure ROIs tab. I strongly encourage to exaggerate the time it takes to fully load ImageJ. By adding 10 more seconds, it will cost you a few minutes overall but it will prevent errors.
