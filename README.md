...
AResCoN is a pipeline developed to perform accurate filtering of cells or nuclei following initial network-based inferences. It uses the output of Cellpose or Stardist and utilizes Fiji to obtain measurements that can be used either for X and Y axis cell filtering or Z-axis cell filtering too within a small range of planes.
